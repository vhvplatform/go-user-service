...
See [ARCHITECTURAL_CONFORMANCE.md](../docs/architecture/ARCHITECTURAL_CONFORMANCE.md) for detailed information.
...
For comprehensive Windows development instructions, including troubleshooting and IDE setup, see the [Windows Development Guide](../docs/windows/WINDOWS_DEVELOPMENT.md).
...
See [../docs/architecture/DESIGN_ANALYSIS_VI.md](../docs/architecture/DESIGN_ANALYSIS_VI.md) for comprehensive design and analysis documentation in Vietnamese.
